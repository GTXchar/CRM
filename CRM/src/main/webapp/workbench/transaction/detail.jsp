<%@ page import="com.nguyenxb.crm.workbench.domain.Tran" %>
<%@ page import="java.util.List" %>
<%@ page import="com.nguyenxb.crm.settings.domain.DicValue" %>
...
<script type="text/javascript">
	...
	function changeStage(stage,i) {
		$.ajax({
			...
			success : function (data) {
				/*
					data:{"success":true/false,"stage":?,"possibility":?,"editBy":?,"editTime":?}
				 */
				if(data.success){
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		-----------
				<%
					...
					else {//如果遍历出来的阶段可能性不为0，说明是前7个，一定是黑圈
				%>
		...
		-----------
			...
			}else {//如果当前阶段的可能性不为0，前7个有可能是绿圈，绿色标记，黑圈，后两个一定是黑叉
